...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull store_card_token;)
+ (NSString * _Nonnull)store_card_token SWIFT_WARN_UNUSED_RESULT;
